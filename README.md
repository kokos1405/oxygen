...
3. Το app «Oxygen Pelatologio» είναι Custom distribution στο Dev Dashboard. Τα custom Partner apps παίρνουν protected customer data αυτόματα, οπότε τα `customers/create`, `customers/update`, `orders/create` και `orders/paid` μένουν στο `shopify.app.toml`. Δεν χρειάζεται ξεχωριστό αίτημα PCD και δεν προστίθενται App Store compliance topics.
